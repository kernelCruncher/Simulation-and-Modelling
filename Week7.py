...
#The state is where the state of the sytems is stored. for example, the traffic light
# and how many cars there are queueing.
### STATE ##########################################
